...
public class Gui implements ActionListener {
    ...
    public Gui(LinkedList<CustomerInformation> customerList, Queue<CustomerInformation> qCounter1,
    Queue<CustomerInformation> qCounter2, Queue<CustomerInformation> qCounter3, int totalCustomer,
    Stack<CustomerInformation> completedStack) {
        ...
        panelCounter1.setBorder(new LineBorder(Color.RED));
        JLabel labelCounter1 = new JLabel("Counter 1");
        labelCounter1.setFont(new Font("Arial", 1, 15));
        ...
        panelCounter2.setBorder(new LineBorder(Color.RED));
        JLabel labelCounter2 = new JLabel("Counter 2");
        labelCounter2.setFont(new Font("Arial", 1, 15));
        ...
        panelCounter3.setBorder(new LineBorder(Color.RED));
        JLabel labelCounter3 = new JLabel("Counter 3");
        labelCounter3.setFont(new Font("Arial", 1, 15));
        ...
        btnDisplay = new JButton("RECEIPTS");
        btnDisplay.setBounds(168, 278, 98, 38);

        // Frame
        frame = new JFrame();
        frame.setTitle("LULU HYPERMARKET");
    ...
    public void actionPerformed(ActionEvent e) {
            ...
            while (iterator.hasNext()) {
                ...
                if (customer.getItemQuantity() <= 5) {
                    ...
                    if (qCounter3.size() < 5) {
                        ...
                        JOptionPane.showMessageDialog(null, "All counter are fully used!");
                        break;
                    }
                }
            }
        ...
        if (e.getSource() == btnPay1) {
            if (!qCounter1.isEmpty()) {
                cust = (CustomerInformation) qCounter1.poll();
                JOptionPane.showMessageDialog(null, "Customer with ID " + cust.getCustId() + " has succesfully paid!");
                queue1--;
        ...
        if (e.getSource() == btnPay2) {
            if (!qCounter2.isEmpty()) {
                cust = qCounter2.poll();
                JOptionPane.showMessageDialog(null, "Customer with ID " + cust.getCustId() + " has successfully paid!");
                queue2--;
